	...
	return (
		<div className="root">
			...
			<AppBar position="static" className="navbar" elevation={4}>
				<Toolbar>
					<Link to="/" className="nav-link"><img src="../head.png" className="nav-logo"/></Link>
					<Typography varirant="h6" className="nav-head">Nbyula Quiz Platform</Typography>
			...
			<Dialog open={loginModalOpen} onClose={onCloseHandle} aria-labelledby="form-dialog-title"
					...
					<div className="modal-info">
						<Typography variant="h5" className="type-head">Are you a student or an Teacher?</Typography>
						<div className="modal-btns">
							...
							<Link to="/login/organizer" className="link">
								<Button variant="outlined" color="secondary" 
									...
									onClick={() => setLoginModalOpen(false)}>Teacher</Button>
							</Link>
						</div>
					</div>
				</Dialog>
